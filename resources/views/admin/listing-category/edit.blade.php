        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('listing-category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="parent_id">
                                    ...
                                    @foreach($categories as $key => $item)
                                        @include('admin.listing-category.includes.option', ['category' => $item, 'selected' => $category->parent_id])
                                    @endforeach
                                </select>
                            </div>
                        @endif
