    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('customer.index') }}" method="GET">
                        <div class="row">
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="keyword" placeholder="Nhập tên khách hàng, số điện thoại, email" value="{{ request()->keyword ?? '' }}">
                            </div>
                            <div class="col-md-3">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    Khách hàng
                    <small class="text-secondary">{{ "Hiển thị " .  $customers->firstItem() . "-" . $customers->lastItem() . " của " . $customers ->total() . ' khách hàng' }}</small>
                </div>
                <div class="card-body">
