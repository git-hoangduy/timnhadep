    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <select name="category" class="form-control select2" style="width: 100%">
                                    ...
                                    @foreach($categories as $category)
                                        @include('admin.post-category.includes.option', ['category' => $category, 'selected' => request()->category, 'full' => 1])
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary">Tìm kiếm</button>
                                <a href="{{ route('post.index') }}" class="btn btn-success">Làm mới</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    Bài viết
                    <small class="text-secondary">{{ "Hiển thị " .  $posts->firstItem() . "-" . $posts->lastItem() . " của " . $posts ->total() . ' bài viết' }}</small>
                </div>
                <div class="card-body">
