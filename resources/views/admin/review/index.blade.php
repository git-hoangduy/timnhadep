...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="mb-3">
                <a href="{{ route('review.create') }}" class="btn btn-success">Thêm mới</a>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-title text-secondary mb-3">Bạn có thể chèn mã [REVIEWS] vào bài viết để hiện thị các đánh giá trong nội dung bài viết.</h6>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('review.edit', $item->id) }}" class="btn btn-primary btn-sm">Chỉnh sửa</a>
                                        <form action="{{ route('review.destroy', $item->id) }}" method="POST" class="d-inline-block">
                                            @csrf
                                            @method("DELETE")
