                ...
                <div class="card-body">
                    ...
                    <form action="{{route('page.update', $page->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="preview-images" style="display: {{ $page->images->count() ? 'flex' : 'none' }}">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-control select2">
                                    <option value="1" {{ $page->status == 1 ? 'selected' : '' }}>Kích hoạt</option>
                                    <option value="0" {{ $page->status == 0 ? 'selected' : '' }}>Không kích hoạt</option>
                                </select>
                            </div>
                        </div>
