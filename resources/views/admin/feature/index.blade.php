...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="mb-3">
                <a href="{{ route('feature.create') }}" class="btn btn-success">Thêm mới</a>
            </div>
            <div class="card mb-4">
                    ...
                    <form action="{{ route('feature.index') }}" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="{{ route('feature.index') }}" class="btn btn-success">Làm mới</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    Nổi bật
                    <small class="text-secondary">{{ "Hiển thị " .  $features->firstItem() . "-" . $features->lastItem() . " của " . $features ->total() . ' nổi bật' }}</small>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <td>
                                        <a href="{{ route('feature.edit', $item->id) }}" class="btn btn-primary btn-sm">Chỉnh sửa</a>
                                        <form action="{{ route('feature.destroy', $item->id) }}" method="POST" class="d-inline-block">
                                            @csrf
                                            @method("DELETE")
